...
# 🔥 News
- [2026.06.15]Doney 发布了 **Just Run2 v1.1.0 Beta** 打磨测试版（元素反应、武器解锁、主菜单退出等）。
...
直接通过以下链接下载游戏👉（Windows，解压后运行 `JustRun2.exe`）：

- **最新**：[Just Run2 v1.1.0 Beta](https://github.com/Dsixy/JustRun2/releases/download/v1.1.0-beta/JustRun2-beta.zip)
- [Just Run2 第一版 (v1.0.1)](https://github.com/Dsixy/JustRun2/releases/download/v1.0.1/Just.Run.zip)
